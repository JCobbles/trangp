...
def artificial_dataset(opt, num_genes=13, num_tfs=3, weights=None, delays=[1, 4, 10]):
    t = np.arange(10)
    ...
    A = np.array([0.01, 0.3, 0.47, 0.51, 0.35, 0.26, 0.37, 0.47, 0.39, 0.2, 0.05, 0.025, 0.025, 0.01, 0.005, 0.005])
